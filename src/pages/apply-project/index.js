...
export default function Example() {
  ...
  const currencyData = useSelector((state) => state?.currencies);
  console.log("@currencyData", currencyData);
  const chainData = useSelector((state) => state?.chains);
  const [steps, setSteps] = useState([
    { id: 1, name: "Token Info", status: "complete" },
    { id: 2, name: "Presale Info", status: "current" },
    { id: 3, name: "Social Media", status: "upcoming" },
  ]);
  ...
  useEffect(() => {
    if (currentStep === 1) {
      setSteps([
        { id: 1, name: "Token Info", status: "current" },
        { id: 2, name: "Presale Info", status: "upcoming" },
        { id: 3, name: "Social Media", status: "upcoming" },
      ]);
      ...
      setSteps([
        { id: 1, name: "Token Info", status: "complete" },
        { id: 2, name: "Presale Info", status: "complete" },
        { id: 3, name: "Social Media", status: "current" },
      ]);
    } else {
      setSteps([
        { id: 1, name: "Token Info", status: "complete" },
        { id: 2, name: "Presale Info", status: "complete" },
        { id: 3, name: "Social Media", status: "complete" },
      ]);
    }
  }, [currentStep]);
  return (
          ...
          <div>
            <div className="md:grid md:grid-cols-3 md:gap-6">
              <div className="md:col-span-1">
                <div className="py-12 px-4 sm:px-6 lg:px-8">
                  <nav className="flex justify-center" aria-label="Progress">
                    <ol role="tablist" className="space-y-6">
                      {steps.map((step) => (
                        <li key={step.name}>
                          {step.status === "complete" ? (
                            <a onClick={() => setCurrentStep(step.id)} className="group">
                            ...
                            <a onClick={() => setCurrentStep(step.id)} className="flex items-start" aria-current="step">
              ...
              <div className="mt-5 md:col-span-2 md:mt-0">
                {currentStep === 1 ? (
                  <form action="#" method="POST" id="ohoy1">
                  ...
                  <form action="#" method="POST" id="ohoy2">
                    <div className="shadow sm:overflow-hidden sm:rounded-md">
                      <div className="space-y-6 bg-white px-4 py-5 sm:p-6">
                        <div className="col-span-6 sm:col-span-3">
                          <label htmlFor="country" className="block text-sm font-medium text-gray-700">
                          ...
                          <select
                            ...
                            className="mt-1 block w-full rounded-md border border-gray-300 bg-white py-2 px-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm"
                          >
                            {/* {currencyData.currencies.data.map((item) => (
                              <option>CROt</option>
                            ))}
                            <option>TEST</option> */}
                          </select>
