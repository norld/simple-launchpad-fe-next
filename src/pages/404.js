...
export default function Example() {
  return (
    <>
      <div className="min-h-full bg-dark px-4 py-16 sm:px-6 sm:py-24 md:grid md:place-items-center lg:px-8">
          ...
          <main className="sm:flex">
            ...
            <div className="sm:ml-6">
              <div className="sm:border-l sm:border-gray-200 sm:pl-6">
                ...
                <p className="mt-1 text-base text-gray-50">Please check the URL in the address bar and try again.</p>
              </div>
